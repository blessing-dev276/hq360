      ...
      GET: async ({ request }) => {
        ...
        try {
          ...
          let query = db
            ...
            .select(
              "*, scout_authors(id, name, country, publishing_type, website_url, contact_email, contact_form_url), scout_review_counts(platform, review_count, rating, verified, retrieved_at), scout_prospects(id, status)",
              { count: "exact" },
            )
