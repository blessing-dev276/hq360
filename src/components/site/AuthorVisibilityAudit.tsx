  ...
  return (
    <>
      <section className="border-b border-border bg-secondary/45">
        <Container className="grid gap-12 py-16 sm:py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-end lg:py-28">
          <div className="max-w-3xl">
            <Eyebrow>HQ360 proprietary tool</Eyebrow>
            <h1 className="mt-5 font-display text-4xl leading-[1.04] text-balance sm:text-5xl lg:text-6xl">
              See what readers see before they decide to buy.
            </h1>
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">
              Get a preliminary view of how your book and author presence appear across the places
              readers use to discover, evaluate and purchase books.
            </p>
          ...
          <div className="rounded-2xl border border-border bg-card p-6 shadow-lift sm:p-7">
